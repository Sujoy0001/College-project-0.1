...
import { FaUser, FaEnvelope, FaBook, FaHashtag, FaClock, FaChevronDown, FaChevronUp, FaSpinner, FaSearch } from 'react-icons/fa';

const AllotmentsListView = () => {
  ...
  return (
    <div className="min-h-full px-4 py-8">
      <div className={`max-w-6xl mx-auto rounded-lg shadow-md overflow-hidden ${darkMode ? 'bg-zinc-800' : 'bg-white'}`}>
        <div className={`p-4 border-b ${darkMode ? 'border-zinc-700 bg-zinc-900' : 'border-gray-200 bg-sky-50'}`}>
                    ...
                    <tr className={`${darkMode ? 'hover:bg-zinc-700' : 'hover:bg-gray-100'}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm font-bold">
                          {calculateTotalHours(teacher.courses)} hrs
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <button
                          ...
                          className={`flex items-center gap-1 text-sm cursor-pointer ${darkMode ? 'text-blue-400 hover:text-blue-300' : 'text-blue-600 hover:text-blue-800'}`}
                        >
...
export default AllotmentsListView;